...
public abstract  class Sort {
	...
	public static void main(String[] args) {
		...
		System.out.println(getkVal(array,0,array.length-1,134));
   ...
   public static int getkVal(int [] array , int index1 , int index2 , int k){
       ...
       if(k-1>p1)return getkVal(array,p1+1,index2,k);
       else return getkVal(array,index1,p1-1,k);
   }
}
