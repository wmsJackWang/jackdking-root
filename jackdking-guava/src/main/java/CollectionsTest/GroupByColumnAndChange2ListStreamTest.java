...
public class GroupByColumnAndChange2ListStreamTest {

    /**
     * @Description: TODO  对流进行处理， 按照某个字段分组，然后将分组的流转化成List类型的流
     * @MethodName:
     * @Param:
     * @return:
     * @Author: jackdking
     ...
     * @Date: 2021/8/21
     *
     * key:woman, value: [jack, john4, john7]
     * key:man, value: [john1, john2, john3, john5, john6, john8]
     **/
    @Test
    public void testGroupByColumnAndChange2SetStream() {
        ...
        Map<String, List<String>> map = userList.stream().collect(Collectors.groupingBy(User::getGender, Collectors.mapping(User::getUsername, Collectors.toList())));
