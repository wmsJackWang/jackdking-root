...
import org.jackdking.delay.domainv1.infrastructure.util.InetAddressUtil;
...
public class IdGenerator {
    ...
    private int length;
    public static final String PROPERTY_IDGENERATOR_HOSTNAME ="jdkmq.idgenerator.hostname";
    public static final String PROPERTY_IDGENERATOR_LOCALPORT ="jdkmq.idgenerator.localport";
    public static final String PROPERTY_IDGENERATOR_PORT ="jdkmq.idgenerator.port";
