...
@Component
@Slf4j
public class RWSeparationWriteMasterReadSlaveStrategy implements RWSeparationStrategy {
    ...
    public RWSeparationStrategyTypeEnum getStrategyType() {
        return RWSeparationStrategyTypeEnum.RW_SEPARATION_WRITE_MASTER_READ_SLAVE;
    }
